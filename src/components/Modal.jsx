  ...
  return (
    <div className="fixed inset-0 z-1 flex items-center justify-center">
      <div
        ...
        onClick={onClose}
      ></div>
      <div className="modal-content bg-white p-6 rounded-lg shadow-lg z-10 w-3/5">
        <h2 className=" text-xl font-bold mb-5 sm: text-center">
          {pokemonName}
        </h2>
        ...
        <div className="flex justify-evenly flex-wrap">
          <div className="left">
            ...
            <div className="w-28 h-1 bg-slate-900 mb-1" />
          ...
          <div className="right ">
            ...
            <div className="w-10 h-1 bg-slate-900 mb-1" />
            ...
            <div className="w-20 h-1 bg-slate-900 mb-1" />
